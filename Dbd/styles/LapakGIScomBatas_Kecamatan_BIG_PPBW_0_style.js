...
var style_LapakGIScomBatas_Kecamatan_BIG_PPBW_0 = function(feature, resolution){
    ...
    var value = feature.get("Data Pendk");
    var labelText = "";
    size = 0;
    ...
    if (value > 24348.000000 && value <= 38009.600000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 38009.600000 && value <= 51671.200000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 51671.200000 && value <= 65332.800000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 65332.800000 && value <= 78994.400000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 78994.400000 && value <= 92656.000000) {
            style = [ new ol.style.Style({
